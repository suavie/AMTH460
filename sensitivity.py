...
for K in K_l:
    ...
    ck3 = monte_carlo_option_price(S,K,T,r,vol,tree_steps)
...
for T in T_l:
    ...
    ct3 = monte_carlo_option_price(S,K,T,r,vol,tree_steps)
...
for r in r_l:
    ...
    cr3 = monte_carlo_option_price(S,K,T,r,vol,tree_steps)
...
for vol in vol_l:
    ...
    cv3 = monte_carlo_option_price(S,K,T,r,vol,tree_steps)
...
for tree_steps in tree_steps_l:
    ...
    cts3 = monte_carlo_option_price(S,K,T,r,vol,tree_steps)
